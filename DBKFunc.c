...
void forOneCpu(CCHAR cpunr, PKDEFERRED_ROUTINE dpcfunction, PVOID DeferredContext, PVOID  SystemArgument1, PVOID  SystemArgument2, OPTIONAL PPREDPC_CALLBACK preDPCCallback)
{
	...
	dpc = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KDPC), 'KDPC');
...
*/
{
	...
	dpc = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KDPC) * cpucount, 'KDPC');
...
*/
{
	...
	dpc = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KDPC) * cpucount, 'DPCM');
