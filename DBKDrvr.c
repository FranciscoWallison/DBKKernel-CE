	...
	--*/
{
	...
	if (RegistryPath)
	{
		...
		if (ntStatus == STATUS_SUCCESS)
		{
			...
			BufDriverString = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KEY_VALUE_PARTIAL_INFORMATION) + 100, 'DrvS');
			BufDeviceString = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KEY_VALUE_PARTIAL_INFORMATION) + 100, 'DevS');
			BufProcessEventString = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KEY_VALUE_PARTIAL_INFORMATION) + 100, 'PrEv');
			BufThreadEventString = ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(KEY_VALUE_PARTIAL_INFORMATION) + 100, 'ThEv');
